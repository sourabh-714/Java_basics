...
public class BFSOperations {
	...
	static void bfs(ArrayList<ArrayList<Integer>> list, boolean marked[], int source) {
	...
	static void bfs_disconnected(ArrayList<ArrayList<Integer>> list,int v) {
	...
	public static void main(String[] args) {
		...
		bfs_disconnected(list, vertices);
	}
